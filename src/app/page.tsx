...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-between bg-gray-950 overflow-hidden font-sans">
      ...
      {/* Main Container */}
      <div className="relative z-10 w-full max-w-md px-6 pt-12 pb-4 sm:px-8 flex-grow flex flex-col justify-center">
        {/* Brand Logo & Header */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center p-3 rounded-2xl bg-brand-emerald/10 border border-brand-emerald/20 mb-4 shadow-[0_0_20px_rgba(16,185,129,0.1)]">
            <svg
              className="w-8 h-8 text-brand-emerald"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
          ...
          <form onSubmit={handleSubmit(onSubmit, onError)} className="space-y-5" noValidate>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <a href="#" className="text-xs text-brand-emerald hover:text-brand-emerald/80 hover:underline transition-all">
                  Forgot Password?
                </a>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-10 py-3 bg-gray-950/50 border rounded-xl text-gray-200 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-brand-emerald/20 focus:border-brand-emerald transition-all text-sm ${
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-gray-800 bg-gray-950/50 text-brand-emerald focus:ring-brand-emerald/20 focus:ring-offset-gray-900 focus:outline-none"
                />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 py-3.5 px-4 mt-6 bg-gradient-to-r from-brand-emerald to-brand-blue hover:from-brand-emerald/90 hover:to-brand-blue/90 text-white font-semibold rounded-xl shadow-lg shadow-brand-emerald/10 focus:outline-none focus:ring-2 focus:ring-brand-emerald/50 focus:ring-offset-2 focus:ring-offset-gray-950 transition-all disabled:opacity-70 disabled:cursor-not-allowed text-sm"
            >
              {isLoading ? (
                <>
